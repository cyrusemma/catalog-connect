      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-display font-bold text-dark-800 dark:text-white">{settings.store_name}</span>
          </Link>
          ...
          <p className="text-dark-800/40 dark:text-white/30 text-xs">© {new Date().getFullYear()} {settings.store_name}</p>
        </div>
      </div>
    </footer>
  )
